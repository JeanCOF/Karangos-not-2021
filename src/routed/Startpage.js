...
//importando a imagem
import ImgCarros from'../some-cars.png'
...
export default function Startpage() {
   ...
   // - figVisible (valor inicial: false)
    ...
    //5. Recupere as informações de https://api.faustocintra.com.br/about/1 e armazene-as na
      // propriedade da variável de estado "about".
    function gData(otherState = state){
    ...
    return (
        <>
            ...
            <div className={classes.div}>
                <img src={ImgCarros} alt="Carros antigos" style={{opacity: state.figVisible ? '1' : '0', height: state.figVisible ? '591px': '0'}} />
            </div>
        </>
    )
}